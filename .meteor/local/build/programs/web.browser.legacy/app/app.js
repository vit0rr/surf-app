...
!function (module1) {
  ...
  var About = function (_ref) {
    ...
    var imageSquareRef = useRef(null);
    var contentSquareRef = useRef(null);
    ...
    useEffect(function () {
      ...
      var ImageSquare = imageSquareRef.current;
      intersectionObserver(ImageSquare, function (event) {
        if (event[0].isIntersecting) ImageSquare.classList.add('animate__fadeInUp');
      }, {
        threshold: 0.75
      });
      var contentSquare = contentSquareRef.current;
      intersectionObserver(contentSquare, function (event) {
  ...
  _s(About, "yRjhmZbf2riZGhyOgCf5lml2HsQ=");
  _c = About;
  var _c;
  $RefreshReg$(_c, "About");
}.call(this, module);
...
!function (module1) {
  ...
  var intersectionObserver, asyncTimeout, getCSSVariable;
  module1.link("../../../../client/scripts/helpers.js", {
    intersectionObserver: function (v) {
      intersectionObserver = v;
    },
  ...
  var Amenities = function (_ref) {
    ...
    useEffect(function () {
      var delay = parseInt(getCSSVariable('--animate-delay'));
      var amenities = document.querySelectorAll('[data-amenity]');
      amenities.forEach(function (amenity, index) {
        intersectionObserver(amenity, function () {
              ...
              function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    wait = delay * index;
                    _context.next = 3;
                    return _regeneratorRuntime.awrap(asyncTimeout(wait));
                  case 3:
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      var key = amenity.name.toLowerCase().replace(/ /g, '-');
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "uk-text-bold uk-text-uppercase",
        style: {
          color: park.theme.secondary
        }
      }, amenity.name), /*#__PURE__*/React.createElement("p", null, amenity.description)), /*#__PURE__*/React.createElement("div", {
...
},"Records.jsx":function module(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// imports/ui/routes/Park/Records.jsx                                                                                  //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
!function (module1) {
  ...
  var Leaderboard;
  module1.link("../../components/Leaderboard.jsx", {
    Leaderboard: function (v) {
      Leaderboard = v;
    }
  }, 1);
  ___INIT_METEOR_FAST_REFRESH(module);
  var _s = $RefreshSig$();
  var Records = function (_ref) {
    var park = _ref.park;
    _s();
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-park__records-corner page-park__records-corner--top-left"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-park__records-corner page-park__records-corner--top-right"
    }, /*#__PURE__*/React.createElement("div", {
      className: "page-park__records-corner-circle page-park__records-corner-circle--inner",
      "uk-icon": "icon: bolt"
    }), /*#__PURE__*/React.createElement("div", {
      ...
      className: "page-park__records-title-group"
    }, /*#__PURE__*/React.createElement("img", {
      src: park.logo,
      className: "page-park__records-logo"
    }), /*#__PURE__*/React.createElement("div", {
      className: "page-park__records-titles"
    }, /*#__PURE__*/React.createElement("h4", {
      className: "page-park__records-subtitle uk-text-uppercase uk-text-bolder uk-h1"
    }, park.name), /*#__PURE__*/React.createElement("p", {
      className: "page-park__records-tagline uk-text-uppercase uk-text-italic"
    }, "\"It's you versus everyone else\""))), /*#__PURE__*/React.createElement(Leaderboard, {
      leaderboards: park.leaderboard,
      park: park
    }));
  };
  _s(Records, "FeeyVvsyND3fLCZz0H/lZSmd4J4=");
  _c = Records;
  var _c;
...
!function (module1) {
  ...
  var getCSSVariable, asyncTimeout, intersectionObserver;
  module1.link("../../../../client/scripts/helpers.js", {
    getCSSVariable: function (v) {
      getCSSVariable = v;
    },
...
},"Leaderboard.jsx":function module(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// imports/ui/components/Leaderboard.jsx                                                                               //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
!function (module1) {
  ...
  var classObserver, getCSSVariable, asyncTimeout, intersectionObserver;
  module1.link("../../../client/scripts/helpers.js", {
    classObserver: function (v) {
      classObserver = v;
    },
    getCSSVariable: function (v) {
      getCSSVariable = v;
  ...
  var _s = $RefreshSig$();
  var updating = false;
  var Leaderboard = function (_ref) {
    var leaderboards = _ref.leaderboards,
      park = _ref.park;
    _s();
    var imageSquareRef = useRef(null);
    var gradient = "repeating-linear-gradient(\n\t\t45deg,\n\t\t" + park.theme.primary + ",\n\t\t" + park.theme.primary + " 5px,\n\t\t" + park.theme.secondary + " 5px,\n\t\t" + park.theme.secondary + " 10px\n\t)";
    ...
    var setSlideIndex = function () {
      ...
      var slider = UIkit.slideshow('.leaderboard__categories-slider');
      if (!slider) return;
      if (next) {
        slider.show('next');
        return;
    ...
    var setSliderHeight = function () {
      function _callee() {
        var container, active, bounds;
        return _regeneratorRuntime.async(function () {
          function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _regeneratorRuntime.awrap(asyncTimeout(500));
              case 2:
                container = document.querySelector('.uk-slideshow-items');
                active = container.querySelector('.uk-active');
    ...
    useEffect(function () {
      var delay = parseInt(getCSSVariable('--animate-delay'));
      var categoryEl = document.querySelector('[data-leaderboard-category]');
      if (!category && leaderboards) {
        var keys = Object.keys(leaderboards);
      ...
      UIkit.util.on('.leaderboard__categories-slider', 'itemshow', function () {
        function _callee2(slide) {
          var id, leaderboard;
          return _regeneratorRuntime.async(function () {
            function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  id = slide.target.getAttribute('data-leaderboard-category');
    ...
    if (!category) return /*#__PURE__*/React.createElement(Fragment, null);
    return /*#__PURE__*/React.createElement("div", {
      className: "leaderboard"
    }, /*#__PURE__*/React.createElement("div", {
      className: "leaderboard-title"
    }, /*#__PURE__*/React.createElement("div", {
      className: "leaderboard-title__left"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "leaderboard-title__right"
    }, /*#__PURE__*/React.createElement("div", {
      className: "leaderboard-title__top",
      style: {
        backgroundColor: park.theme.primary
      ...
      className: "leaderboard__categories-description"
      ...
      className: "leaderboard__categories-nav"
    }, /*#__PURE__*/React.createElement("button", {
      "uk-icon": "icon: triangle-left",
      onClick: function () {
        return setSlideIndex(false);
      }
    }), /*#__PURE__*/React.createElement("button", {
      "uk-icon": "icon: triangle-right",
      onClick: function () {
        return setSlideIndex(true);
      }
    })), /*#__PURE__*/React.createElement("div", {
      ...
      className: "uk-slideshow-items"
    }, Object.keys(leaderboards).map(function (key) {
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        className: "leaderboard__record leaderboard__record--header uk-text-uppercase uk-text-bold"
      }, Object.keys(leaderboard.header).map(function (header, index) {
        var width = 100 / Object.keys(leaderboard.header);
        var label = leaderboard.header[header];
        var Place = /*#__PURE__*/React.createElement("span", {
          key: "place",
        ...
        var Cell = /*#__PURE__*/React.createElement("span", {
          key: header,
      ...
      })), leaderboard.records.map(function (record, index) {
        var keys = Object.keys(record);
        var width = 100 / (keys.length + 1);
        return /*#__PURE__*/React.createElement("p", {
        ...
        }, index + 1), keys.map(function (key) {
          var header = leaderboard.header[key];
          ...
          if (leaderboard.header[key] && key == 'name') {
            ...
            }, record.image && /*#__PURE__*/React.createElement("img", {
              src: record.image
            }), value);
          }
          if (leaderboard.header[key] && key != 'image' && key != 'name') {
            ...
            }, value, ' ', key == 'value' ? /*#__PURE__*/React.createElement("abbr", {
  ...
  _s(Leaderboard, "BWQf2k9CJvTk8I0nf65hy01ejrA=");
  _c = Leaderboard;
  var _c;
...
},"leaderboard.js":function module(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// client/scripts/data/leaderboard.js                                                                                  //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
!function (module1) {
  ...
  var faker;
  module1.link("@faker-js/faker", {
    faker: function (v) {
      faker = v;
    }
  }, 0);
  var randomInt, sortBy;
  module1.link("../helpers.js", {
    randomInt: function (v) {
      randomInt = v;
    },
    sortBy: function (v) {
  ...
  ___INIT_METEOR_FAST_REFRESH(module);
  var createRecord = function (limit, minValue, maxValue) {
    var records = [];
  ...
  var leaderboard = {
    aerial: {
      ...
      'measurement-abbr': 'ft',
      icon: '',
      description: 'Launch above the wake that is 3 feet or greater. Aerial height must be confirmed by park staff.',
      reward: null,
      header: {
        name: 'Rider',
        image: true,
    ...
    'best-lap': {
      ...
      icon: '',
      description: 'Fastest lap from start point to end point marked on the inside of the wave pool. Laps must be recored by park staff.',
      reward: null,
      header: {
        name: 'Rider',
        image: true,
    ...
    'hours-logged': {
      ...
      icon: '',
      description: 'Total number of hours logged in the wave park greater than 100 hours. Riders check in and out at the front desk to record time.',
...
!function (module1) {
  ...
  module1.exportDefault(park = {
    ...
    amenities: [{
      ...
      image: 'https://cdn.choosechicago.com/uploads/2019/06/aucheval1_7ad98887-11be-4c0a-aaba-fd3401c8a1bb.jpg',
      icon: './burger.png'
    }, {
      id: 'cold-bar',
      name: 'Cold Bar',
      description: 'Salads, Sandwiches, and Smoothies',
      image: 'https://www.getserveware.com/wp-content/uploads/2022/09/bugambilia-outdoor-poolside-cold-bar-salad-buffet-display.jpg',
      icon: './salad.png'
    }, {
      id: 'cafe',
      name: 'Cafe',
      description: 'Baked Goods and Coffee options',
      image: 'https://media.cntraveler.com/photos/5b9041bdf43e7d37b8df83e0/16:9/w_2560,c_limit/Backstreet%20Cafe_2018_Solarium_2064.JPG',
      icon: './coffee.png'
    }, {
      id: 'ice-cream',
      name: 'Ice Cream',
      description: 'Desserts, Shakes, and Cones',
      image: 'https://www.inquirer.com/resizer/VrOtqRQmqOGi2aZU3f8cK_K3EM8=/760x507/smart/filters:format(webp)/cloudfront-us-east-1.images.arcpublishing.com/pmn/6VS3Z2KJC5EERAWB2N3NOOX3GE.jpg',
      icon: './ice-cream.png'
    }, {
      id: 'bar',
      name: 'Bar',
      description: 'Our name, Barreled, is the bridge between surf culture and Yakima.  It’s not only the pinnacle maneuver in surfing, it’s also a tip of the cap to Yakima’s distinguished craft beverage industry, which uses barrels for aging and measuring.',
      image: 'https://images.squarespace-cdn.com/content/v1/5f7a25adebb0954c5ed99fa6/1619790637949-6W4XNSZUSXI8BMGN48YC/120946727_3461739960580141_1519337992975036759_n.jpg',
      icon: './wine.png'
    }, {
      id: 'lodging',
      name: 'Lodging',
...
!function (module1) {
  ...
  var classObserver = function (el, classname, on, off) {
    if (!window) return;
