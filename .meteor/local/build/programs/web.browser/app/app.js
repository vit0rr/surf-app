...
!function (module1) {
  ...
  let intersectionObserver, asyncTimeout, getCSSVariable;
  module1.link("../../../../client/scripts/helpers.js", {
    intersectionObserver(v) {
      intersectionObserver = v;
    },
  ...
  const Amenities = function (_ref) {
    ...
    useEffect(() => {
      ...
      amenities.forEach((amenity, index) => {
        intersectionObserver(amenity, async event => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        "uk-toggle": "target: #".concat(amenity.id),
        type: "button"
      }, /*#__PURE__*/React.createElement("img", {
        src: amenity.icon
      }), /*#__PURE__*/React.createElement("span", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          backgroundImage: "url(".concat(amenity.image, ")")
        },
...
!function (module1) {
  ...
  let getCSSVariable, asyncTimeout, intersectionObserver;
  module1.link("../../../../client/scripts/helpers.js", {
    getCSSVariable(v) {
      getCSSVariable = v;
    },
  ...
  const Park = function (props) {
    ...
    return /*#__PURE__*/React.createElement("main", {
      ...
      className: "page-park__park-records animate__animated animate__delay-1s ".concat(animation)
...
!function (module1) {
  ...
  let classObserver, getCSSVariable, asyncTimeout, intersectionObserver;
  module1.link("../../../client/scripts/helpers.js", {
    classObserver(v) {
      classObserver = v;
    },
  ...
  var _s = $RefreshSig$();
  let updating = false;
  const Leaderboard = function (_ref) {
    let {
      leaderboards,
      park
    } = _ref;
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => setSlideIndex(false)
    }), /*#__PURE__*/React.createElement("button", {
      "uk-icon": "icon: triangle-right",
      onClick: () => setSlideIndex(true)
    })), /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        const Place = /*#__PURE__*/React.createElement("span", {
          key: "place",
        ...
        const Cell = /*#__PURE__*/React.createElement("span", {
          key: header,
          className: "leaderboard__record-".concat(header, " leaderboard__record-header"),
          style: {
            width: width + '%'
          }
        }, label);
        ...
        return /*#__PURE__*/React.createElement("p", {
          ...
          if (leaderboard.header[key] && key == 'name') {
            return /*#__PURE__*/React.createElement("span", {
              key: key,
              className: "leaderboard__record-".concat(key),
              style: {
                width: width + '%'
              }
...
!function (module1) {
  ...
  const classObserver = function (el, classname, on, off) {
    if (!window) return;
